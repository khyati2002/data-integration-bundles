...
public class DeliveryPJPTransformer  extends AbstractTransformer<Map<String, Object>, Map<String, Object>> {
    ...
    public Map<String, Object> transform(Map<String, Object> inputMap) {
        ...
        result.put("pjpDate", getPjpDateAsLocalDateTime(inputMap, "pjpDate"));
    ...
    private LocalDateTime getPjpDateAsLocalDateTime(Map<String, Object> map, String key) {
        Object value = map.get(key);
        if (value == null) return null;
        ...
        try {
            ...
            // Try to parse as LocalDate first (yyyy-MM-dd format from streaming data)
            try {
                LocalDate localDate = LocalDate.parse(dateStr, DateTimeFormatter.ofPattern("yyyy-MM-dd"));
                return localDate.atStartOfDay();
            } catch (DateTimeParseException e) {
                // Continue to other formatters
            }
