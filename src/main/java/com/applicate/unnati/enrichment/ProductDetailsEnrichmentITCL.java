...
public class ProductDetailsEnrichmentITCL extends AbstractEnrichment<ProductDetails> {
	...
	public EnrichmentResult apply(ProductDetails cdm) {
		String s = StringUtils.isEmpty(cdm.getSkuDescription()) ? cdm.getSkuName() : cdm.getSkuDescription() + "~~" + cdm.getMarketSku() + "~~" + cdm.getCategory() + "~~" + cdm.getSubCategory() + "~~" + (String.valueOf(cdm.getMrp()) == null ? "0" : String.valueOf(cdm.getMrp()));
