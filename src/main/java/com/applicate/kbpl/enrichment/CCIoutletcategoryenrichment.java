...
//    private final RoleService roleService = SpringContext.getBean(RoleService.class);
...
//        cdm.setLocationHierarchy(enrichLocation(cdm.getLocationHierarchy()));
//        cdm.setMarketId(enrichField(cdm.getMarketId(), outletCategoryMap.get("2")));
//        cdm.setMarketName(enrichField(cdm.getMarketName(), outletCategoryMap.get("3")));
...
//            List<GenericEntity> cc2map = repository.findByNameAndKey1AndKey2(OUTLETCATEGORY, "2", areacode);
//            if (!cc2map.isEmpty()) {
