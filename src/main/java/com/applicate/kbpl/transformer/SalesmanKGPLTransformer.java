...
public class SalesmanKGPLTransformer extends AbstractTransformer<Map<String, Object>, Map<String, Object>> {
    ...
    public Map<String, Object> transform(Map<String, Object> inputMap) {
        ...
        ifEmpty(inputMap.get("isactive")).ifPresent(val -> responseMap.put("activeStatus", setActiveFunctionKGPL(inputMap.get("isactive").toString())));

        StringBuilder loginIdBuilder = new StringBuilder();
        loginIdBuilder.append(salesmanCode).append("-").append(tenantCode).append(KGPL);
        ...
        ifEmpty(tenantCode).ifPresent(val -> {
            Map<Object, Object> immediateParent = Map.of("immediateParent", val + KGPL);
            responseMap.put("immediateParent", immediateParent);
            extendedAttributes.put(TENANTCODE, val + KGPL);
        });
    ...
    private Object setActiveFunctionKGPL(String isActive) {
