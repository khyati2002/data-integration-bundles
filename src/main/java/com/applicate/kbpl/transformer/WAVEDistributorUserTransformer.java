...
public class WAVEDistributorUserTransformer extends AbstractTransformer<Map<String, Object>, Map<String, Object>> {
    ...
    public Map<String, Object> transform(Map<String, Object> inputMap) {
        ...
        // 2 & 3. loginId and userAccountId = appendWAVE(distributorcode)
        String distributorCode = safeString(inputMap.get("distributorcode"));
        String appendedCode = appendWAVE(distributorCode);
    ...
    // Mimics the appendWAVE function (appends "WAVE" suffix)
    private String appendWAVE(String code) {
        return code != null ? code + "-WAVE" : null;
    }
