...
public class SalesmanWAVETransformer extends AbstractTransformer<Map<String, Object>, Map<String, Object>> {
    ...
    public Map<String, Object> transform(Map<String, Object> inputMap) {
        ...
        ifEmpty(inputMap.get("isactive")).ifPresent(val -> responseMap.put("activeStatus", setActiveFunctionWAVE(inputMap.get("isactive").toString())));

        StringBuilder loginIdBuilder = new StringBuilder();
        loginIdBuilder.append(salesmanCode).append("-").append(tenantCode).append(WAVE);
        ...
        ifEmpty(tenantCode).ifPresent(val -> {
            Map<Object, Object> immediateParent = Map.of("immediateParent", val + WAVE);
            responseMap.put("immediateParent", immediateParent);
            extendedAttributes.put(TENANTCODE, val + WAVE);
        });
    ...
    private Object setActiveFunctionWAVE(String isActive) {
