...
public class SalesValidateTransformer extends AbstractTransformer<Map<String, Object>, Map<String, Object>> {
            ...
            try {
                ...
                for (Map<String, Object> feature : features) {
                    try {
                        ...
                        User supplier = userService.findByLoginId(feature.getOrDefault("supplier", "").toString());
                        OutletDetails outlet = outletDetailsService.findByOutletCode(feature.getOrDefault("outletCode", "").toString());
                        ...
                        feature.put("outletName", outlet.getOutletName());
                        feature.put("supplierName", supplier.getName());
                    } catch (Exception e) {
                    ...
                    float lineCount = orderDetails.stream().filter(ord->Float.parseFloat(ord.get("initialNormalizedQuantity").toString()) > 0).count();
