...
public class CokeArgKpiRecuperacionTransformer extends AbstractTransformer<Map<String, Object>, Map<String, Object>> {
    ...
    public Map<String, Object> transform(Map<String, Object> inputMap) {
        ...
        if (inputMap.containsKey("ruta") && inputMap.get("ruta") != null) {
            ...
            responseMap.put("name","kpi_recuperacion_ruta");
        ...
        if (inputMap.containsKey("supervisor") && inputMap.get("supervisor") != null) {
            ...
            responseMap.put("name","kpi_recuperacion_supervisor");
            responseMap.put("target","USER");
        }
