...
public EnrichmentResult apply(OutletDetails cdm)
{
    ...
    if (!ObjectUtils.isEmpty(cc1)) {
        List<GenericEntity> cc1map = genericEntityService.findByNameAndKey1AndKey2("Outletcategory", "1",cc1 );
        if (!cc1map.isEmpty()) {
    ...
    if (!ObjectUtils.isEmpty(cc2)) {
        List<GenericEntity> cc2map = genericEntityService.findByNameAndKey1AndKey2("Outletcategory", "2", cc2);
        if (!cc2map.isEmpty()) {
    ...
    if (extendedAttributes.has("tradename")) {
        ...
        List<GenericEntity> cc3map = genericEntityService.findByNameAndKey1AndKey2("Outletcategory", "3", cc3);
        if(!cc3map.isEmpty()) {
    ...
    if (extendedAttributes.has("suppression_reason")) {
        ...
        List<GenericEntity> cc4map = genericEntityService.findByNameAndKey1AndKey2("Outletcategory", "4", cc4);
        if(!cc4map.isEmpty()) {
    ...
    if (!ObjectUtils.isEmpty(salesoffice)) {
        List<GenericEntity> marketnameMapping = genericEntityService.findByNameAndKey1AndKey2("Outletcategory", "5", salesoffice);
    ...
    if (extendedAttributes.has("PMNTTRMS")) {
        ...
        List<GenericEntity> cc7map = genericEntityService.findByNameAndKey1AndKey2("Outletcategory", "6", cc7);
        if(!cc7map.isEmpty()) {
    ...
    if (!ObjectUtils.isEmpty(cc8)) {
        List<GenericEntity> cc8map = genericEntityService.findByNameAndKey1AndKey2("Outletcategory", "8", cc8);
        if (!cc8map.isEmpty()) {
    ...
    if (!ObjectUtils.isEmpty(priceid)) {
        List<GenericEntity> priceidMapping = genericEntityService.findByNameAndKey1AndKey2("Outletcategory", "9", priceid);
    ...
    if (extendedAttributes.has("trade_channel")) {
        ...
        List<GenericEntity> cc10map = genericEntityService.findByNameAndKey1AndKey2("Outletcategory", "10", cc10);
        if(!cc10map.isEmpty()) {
    ...
    if (!ObjectUtils.isEmpty(class1)) {
        List<GenericEntity> classMapping = genericEntityService.findByNameAndKey1AndKey2("Outletcategory", "11", class1);
    ...
    if (!ObjectUtils.isEmpty(class1)) {
        List<GenericEntity> sourceMapping = genericEntityService.findByNameAndKey1AndKey2("Outletcategory", "12", source);
    ...
    if (!ObjectUtils.isEmpty(subchannel)) {
        List<GenericEntity> subchannelMapping = genericEntityService.findByNameAndKey1AndKey2("Outletcategory", "14", subchannel);
    ...
    if (!ObjectUtils.isEmpty(districhannel)) {
        List<GenericEntity> districhannelMapping = genericEntityService.findByNameAndKey1AndKey2("Outletcategory", "15", districhannel);
    ...
    if (!ObjectUtils.isEmpty(outlettype)) {
        List<GenericEntity> outlettypeMapping = genericEntityService.findByNameAndKey1AndKey2("Outletcategory", "16", outlettype);
    ...
    if (extendedAttributes.has("ship_condition")) {
        ...
        List<GenericEntity> cc17map = genericEntityService.findByNameAndKey1AndKey2("Outletcategory", "17", cc17);
        if(!cc17map.isEmpty()) {
