...
public class SeparateFreeItemsAndCouponValueGet extends AbstractTransformer<Map<String, Object>, List<Map<String, Object>>> {
    ...
    private AbstractOrderDetails createNewOrderDetails(Map<String,Object> orderDetail) {
        ...
        orderDetails.setBatchCode(orderDetail.get(BATCH_CODE).toString());
        orderDetails.setSkuCode(orderDetail.get(SKU_CODE).toString());
        orderDetails.setPieceQuantity(Float.parseFloat(orderDetail.get(PIECE_QUANTITY).toString())- Float.parseFloat(orderDetail.get(INITIAL_PIECE_QUANTITY).toString()));
        orderDetails.setCaseQuantity(Float.parseFloat(orderDetail.get(CASE_QUANTITY).toString())- Float.parseFloat(orderDetail.get(INITIAL_CASE_QUANTITY).toString()));
        ...
        orderDetails.setNormalizedQuantity(Float.parseFloat(orderDetail.get(NORMALIZED_QUANTITY).toString())- Float.parseFloat(orderDetail.get(INITIAL_NORMALIZED_QUANTITY).toString()));
        return orderDetails;
    }
